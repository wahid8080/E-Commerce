                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists())
                    {
                        ...
                        if (dataSnapshot.hasChild("Security Questions"))
                        {
                            ...
                            {
                                Toast.makeText(ResetPasswordActivity.this, "Your first answer its wrong!", Toast.LENGTH_SHORT).show();
                            }
                            else if (!ans2.equals(answer2))
                            {
                                Toast.makeText(ResetPasswordActivity.this, "Your second answer its wrong!", Toast.LENGTH_SHORT).show();
                            } else {
